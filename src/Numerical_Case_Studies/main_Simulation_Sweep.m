...
for node_limit_cnt = 1:n_node_limits
    if ~bnb_sdp_deactivation
        fprintf("\nStart simiulating b&b+SDP and oracle ...\n");
    else
        fprintf( ...
            "Start simulating node limit " + ...
            num2str(node_limit_cnt-1) + ...
            " of " + num2str(n_node_limits-1) + " ...\n" ...
        );
    end
    node_limit_t0 = tic;
    for sim_cnt = 1:n_sims
        ...
        fprintf( ...
            "  " + num2str(sim_cnt) + "/" + ...
            num2str(n_sims) + " simulations with " + ...
            num2str(n_steps) + " steps completed.\n" ...
        );
    ...
    if ~bnb_sdp_deactivation
        fprintf( ...
            "  Finished simulating b&b+SDP and oracle after " + ...
            num2str(node_limit_sim_time) + "s.\n\n" + ...
            "Continue simulating b&b at different node limits ...\n" ...
        );
    else
        fprintf( ...
            "  Finished simulating node limit " + ...
            num2str(node_limit_cnt-1) + " of " ...
            + num2str(n_node_limits-1) + " after " + ...
            num2str(node_limit_sim_time) + "s.\n" ...
        );
    end
