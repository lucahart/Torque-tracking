...
epsilon = 1e-4;
sdp.sdpopt = sdpsettings('solver', 'scs', 'verbose', 0, 'dualize', 0, 'scs.eps_abs', epsilon, 'scs.eps_rel', epsilon);
...
% Switching penalty
% Switching penalty depending on u_prev
